...
namespace ProjectRasterTest
{
	...
	{
		private const string _dockPaneID = "ProjectRasterTest_MainDockpane";
		...
		protected MainDockpaneViewModel()
		{
			Raster = new Raster()
			{
				...
				RasterOutputDirectory = "C:\\Users\\lukes\\OneDrive\\Documents\\PLUCURN\\ProjectRasterTest"
			};
		}
